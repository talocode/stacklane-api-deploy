export const PRODUCT_REGISTRY = {
  ...
  doculane: { name: 'DocuLane', summary: 'Office document workflows', operations: ['read', 'write', 'info'] },
  ...
  policylane: { name: 'PolicyLane', summary: 'Deterministic action policy checks', operations: ['check'] },
  ...
  reliabilitylane: { name: 'ReliabilityLane', summary: 'Reliability checks and receipts', operations: ['verify'] },
  ...
  videolane: { name: 'VideoLane', summary: 'Video planning and production workflows', operations: ['plan', 'captions', 'metadata'] },
